...
export default function ServicesSection() {
  ...
  const cardVariant = {
    hidden: isMobile ? { opacity: 0, y: 40 } : { opacity: 0, y: 50, scale: 0.95 },
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <a
                  className="mt-5 text-primary font-body font-bold text-md flex items-center gap-1 hover:gap-2 transition-all"
                  href={service.link}
                >
                  Know more →
                </a>
